...
Vagrant.configure("2") do |config|
  ...
  config.vm.synced_folder ".", "/home/vagrant/algorithm", :create => true, :owner=> 'vagrant', :group=>'vagrant', :mount_options => ['dmode=777,fmode=777']
  ...
  if ARGV[0] == 'up'
    config.vm.provision "ansible_local" do |ansible|
      ansible.playbook = "algorithm.yml"
